    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClockingStaffId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StafId = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    LeaveOnBreakTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReturnOnBreakTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    WorkingHours = table.Column<TimeSpan>(type: "time", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClockingsStaff", x => x.ClockingStaffId);
                    table.ForeignKey(
                        name: "FK_ClockingsStaff_Staffs_StafId",
                        column: x => x.StafId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClockingId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VoluntId = table.Column<long>(type: "bigint", nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClockInTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ClockOutTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LeaveOnBreakTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clockings_Volunteers_VoluntId",
                        column: x => x.VoluntId,
